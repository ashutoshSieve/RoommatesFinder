...
const socket = io("https://roommatesfinder-1.onrender.com", {
...
const ChatHistory = () => {
  ...
  const fetchChats = async () => {
    try {
      const res = await fetch("https://roommatesfinder-1.onrender.com/api/chats", {
        method: "GET",
        credentials: "include",
      });
  ...
  const handleChatOpen = async (chatId) => {
    try {
      await fetch(`https://roommatesfinder-1.onrender.com/api/messages/${chatId}/read`, {
        method: "PUT",
        credentials: "include",
      });
            ...
            <div className="space-y-4">
              {chats.map((chat) => {
                const imageUrl = chat.profileImage
                  ? `https://roommatesfinder-1.onrender.com${chat.profileImage}`
